...
- MagnetMaze Lite turns the user's request into a directly usable game workflow. The first experience must be the actual browser game behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a compact browser-game called MagnetMaze Lite. It should be a full-viewport arcade puzzle game where the player steers a charged orb through a neon maze, toggles magnetic polarity to repel or attract gates, collects three energy cores, avoids moving hazards, and reaches an exit portal. Include a playab…
...
- Gameplay - MagnetMaze Lite
- Game Settings - MagnetMaze Lite

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Gameplay - MagnetMaze Lite
...
SCREEN_SPEC_2:
- exact_screen_title: Game Settings - MagnetMaze Lite
